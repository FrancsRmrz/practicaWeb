...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-dark shadow-sm" id="abrirCategoria">
...
<div id="categorias" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="background-color: #fffff; color: white;"> <!-- Cambiado a fondo oscuro y texto blanco -->
            <div class="modal-header bg-dark text-white"> <!-- Cambiado a fondo oscuro y texto blanco -->
            ...
            <div class="modal-body">
                <form action="" method="POST" autocomplete="off">
                    <div class="form-group">
                        <label for="nombre" style="color: black;">Nombre</label> <!-- Cambiado a texto blanco -->
