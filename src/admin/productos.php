...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="border: 2px; border-color: black;" id="abrirProducto">
                        ...
                        <tr>
                            ...
                            <td>
                                <form method="post" action="eliminar.php?accion=pro&id=<?php echo $data['id']; ?>" class="d-inline eliminar">
                                    <button class="btn eliminar button" type="submit">Eliminar</button>
                                </form>
                            </td>
                        </tr>
                    <?php } ?>
...
<div id="productos" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-black text-white"> <!-- Cambiado a fondo negro -->
            ...
            <div class="modal-body">
                <form action="" method="POST" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <button class="btn btn-dark" type="submit">Registrar</button> <!-- Cambiado a botón oscuro -->
                </form>
            </div>
        </div>
    </div>
